  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        {/* Subheading */}
        <p
          className={`text-[#000000] font-montserrat text-sm md:text-base uppercase tracking-widest mb-8 transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
        ...
        >
          <button className="px-10 py-4 bg-[#AE8F56] text-[#9D5088] font-montserrat uppercase tracking-wide hover:bg-[#FDE68A] transition-all duration-300 hover:shadow-lg hover:shadow-[#AE8F56]/20">
            Book a Site Visit
          </button>
        ...
        {/* RERA */}
        <p className="text-[#000000]/60 text-xs font-montserrat uppercase tracking-wider">
